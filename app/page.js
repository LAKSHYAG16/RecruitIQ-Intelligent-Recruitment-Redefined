  ...
  return (
    <div className="container h-screen">
      ...
      <div className="hero text-center m-10 mt-16">
        ...
        <h1 className="text-5xl orbitron text-gradient max-w-[55vw] m-auto">Revolutionize Your Hiring Process with RecruitIQ</h1>


        <p className="max-w-[65vw] m-auto mt-5 text-lg poppins subtext-gradient">Experience the future of recruitment with AI-powered automation. From resume screening to candidate assessment, RecruitIQ makes hiring smarter, faster and more efficient</p>

        <div className="buttons flex justify-center mt-10 m-5">
          <Link href={"/about"}>
            <button type="button" className="flex items-center gap-1 text-white bg-gradient-to-r from-[#451d84] to-[#8c44f7]
 hover:bg-gradient-to-br font-medium rounded-lg text-base px-5 py-4 text-center me-2 mb-2 mr-3">
              Learn more about us
              <span><img className="invert" width={20} src="arrow.png" alt="" /></span>
            </button>
          </Link>
          ...
          <Link href={"/login"}>
            <button type="button" className="flex items-center gap-1 text-gray-900 bg-gradient-to-r from-[#585858] to-[#9a9a9a] hover:bg-gradient-to-br  font-medium rounded-lg text-base px-5 py-4 text-center me-2 mb-2 ml-3">
              Start Now
      ...
      <div id="features" className="features flex flex-col gap-36 m-10 mb-0 pb-0 mt-5 p-20">
        <div className="feature flex justify-evenly items-center gap-5">
          ...
          <div className="feature-right flex flex-col gap-4 justify-center">
            ...
            <p className="max-w-[35vw] text-center justify-center text-2xl  text-gray-600">No bloated UI or steep learning curves. The RecruitIQ platform is straightforward but effective; it is available to and pertinent to all recruiters and candidates.</p>
          </div>
        </div>
        ...
        <div className="feature flex justify-evenly items-center gap-5">
          <div className="feature-left flex flex-col gap-4 justify-center items-center">
            ...
            <p className="max-w-[35vw] text-center text-2xl text-gray-600">Use AI-powered resume screening tools to parse and evaluate candidate experience quickly. The website also offers AI-driven candidate recommendations. The website will leverage an AI-powered Recruitment Bot to improve hiring efficiency.</p>
          </div>
        ...
        <div className="feature flex justify-evenly items-center gap-5">
          <div className="feature-left flex flex-col gap-4 justify-center items-center">
            ...
            <p className="max-w-[40vw] text-center text-2xl text-gray-600">Use AI to generate detailed candidate insights beyond standard resume screening, such as:
