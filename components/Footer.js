                        ...
                        <div className="card">
                            <div className="logo">
                                ...
                                <span className="circle circle5">
                                    <img src="logo.webp" alt="logo" className="rounded-full" />
                                    {/* <img src="AIcruit_nobg.png" alt="logo" /> */}
                                    {/* <img src="b&w_aicruit.png" alt="logo" /> */}
                                </span>

                            </div>
                            {/* <div className="footer-footer-glass"></div> */}
                ...
                <div className="right">
                    <div className="parent-right flex gap-3">
                        ...
                        <div className="child child-3">
                            <button onClick={() => window.open("https://github.com/LAKSHYAG16", "_blank")} className="flex items-center justify-center button btn-3">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="1.5em"
                                    viewBox="0 0 496 512"
                    ...
                    <p className='mt-[20px] text-[#3d2080]'>RecruitIQ - Copyright &copy; 2025 | CLOVER | All rights reserved</p>
